...
void Board::instructions()
{
	...
	cout << "\n **TO PLAY CHECKERS GAME** \n\n";
	cout << endl << s << "  THESE ARE THE INSTRUCTION FOR TO SHOW HOE TO PLAY!          \n " << s << endl;
	cout << s << "  1) The computer is represented by a 'B'           " << s << endl;
	cout << s << "  2) The human is represented by a 'W'              " << s << endl;
